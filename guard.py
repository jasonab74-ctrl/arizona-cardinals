#!/usr/bin/env python3
# Guard runner — prevents regressions while still auto-updating
...
ALLOWED_SOURCES = {
    "Arizona Cardinals","Arizona Sports","Revenge of the Birds","PHNX Cardinals",
    "Cardinals Wire","ESPN","Yahoo Sports","Sports Illustrated","CBS Sports","The Athletic",
}
